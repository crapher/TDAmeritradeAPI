...
{
    // https://developer.tdameritrade.com/content/streaming-data#_Toc504640611
    public class LevelOneFuturesOptions : IUpdatableBySymbol<LevelOneFuturesOptions>
    {
        [DataMember(Name = "key")]
        ...
        public void Update(LevelOneFuturesOptions updatedObject)
        {
            Symbol = updatedObject.Symbol ?? Symbol;
            ...
            ExhangeName = updatedObject.ExhangeName ?? ExhangeName;
